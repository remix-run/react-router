  ...
  describe("parentMatch", () => {
    ...
    describe("partial path", () => {
      it("joins with parentMatch.url before matching", () => {
        ...
        const match = matchPath("/state/WI", { path: "WI" }, parentMatch);
      ...
      it("works when parentMatch.url has trailing slash", () => {
        ...
        const match = matchPath("/state/OR", { path: ":state" }, parentMatch);
      ...
      it("resolves using root when parentMatch is null", () => {
        const match = matchPath("/state/CA", { path: "state/:state" }, null);
      ...
      describe('with path=""', () => {
        it("matches using parentMatch.url", () => {
          ...
          const match = matchPath("/state/WA", { path: "" }, parentMatch);
    ...
    describe("undefined path", () => {
      it("inherits parent's match.url and path", () => {
        ...
        const match = matchPath("/state/OR", {}, parentMatch);

        expect(match.url).toBe("/state");
        expect(match.path).toBe("/state");
      });

      it("is null when there is no parent match", () => {
        const match = matchPath("/state/OR", {}, null);
