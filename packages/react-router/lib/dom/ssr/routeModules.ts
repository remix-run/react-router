...
/**
 * Optional `<Route Layout>` component to wrap the route content in.
 * Useful for keeping a persistent shell around the Component, HydrateFallback,
 * and ErrorBoundary across all three states.
 */
