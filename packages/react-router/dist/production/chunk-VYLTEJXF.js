...
var isAbsoluteUrl = (url) => ABSOLUTE_URL_REGEX.test(normalizeRelativeUrl(url));
...
function parseToInfo(_to, basename) {
  let to = typeof _to === "string" ? normalizeRelativeUrl(_to) : _to;
