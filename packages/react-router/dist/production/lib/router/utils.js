 ...
 * @license MIT
 */
import { ABSOLUTE_URL_REGEX, PROTOCOL_RELATIVE_URL_REGEX, normalizeProtocolRelativeUrl, normalizeRelativeUrl } from "./url.js";
...
const isAbsoluteUrl = (url) => ABSOLUTE_URL_REGEX.test(normalizeRelativeUrl(url));
/**
