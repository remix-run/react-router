...
import { RelativeRoutingType, Router, StaticHandlerContext } from "./router/router.js";
...
type DataRouterDataContextObject = Pick<Router["state"], "loaderData" | "actionData" | "errors">;
type DataRouterNavigationContextObject = Pick<Router["state"], "navigation" | "revalidation">;
type DataRouterStateContextObject = Omit<Router["state"], keyof DataRouterDataContextObject | keyof DataRouterNavigationContextObject | "fetchers">;
declare const DataRouterStateContext: React$1.Context<DataRouterStateContextObject | null>;
declare const DataRouterDataContext: React$1.Context<DataRouterDataContextObject | null>;
declare const DataRouterNavigationContext: React$1.Context<DataRouterNavigationContextObject | null>;
...
declare const FetchersContext: React$1.Context<FetchersContextObject | null>;
...
//#endregion
export { AwaitContextProvider, DataRouterContext, DataRouterDataContext, DataRouterNavigationContext, DataRouterStateContext, FetchersContext, LocationContext, NavigateOptions, NavigationContext, Navigator, RouteContext, ViewTransitionContext };