...
const DataRouterDataContext = React$1.createContext(null);
DataRouterDataContext.displayName = "DataRouterData";
const DataRouterNavigationContext = React$1.createContext(null);
...
const FetchersContext = React$1.createContext(null);
...
const RouteIdContext = React$1.createContext(void 0);
RouteIdContext.displayName = "RouteId";
const RouteErrorContext = React$1.createContext(null);
RouteErrorContext.displayName = "RouteError";
//#endregion
export { AwaitContext, AwaitContextProvider, DataRouterContext, DataRouterDataContext, DataRouterNavigationContext, DataRouterStateContext, FetchersContext, LocationContext, NavigationContext, RSCRouterContext, RouteContext, RouteErrorContext, RouteIdContext, ViewTransitionContext, useIsRSCRouterContext };
