...
import { DataRouterContext, DataRouterDataContext, DataRouterStateContext, useIsRSCRouterContext } from "../../context.js";
...
function useDataRouterDataContext() {
	let context = React$1.useContext(DataRouterDataContext);
	invariant(context, "You must render this element inside a <DataRouterDataContext.Provider> element");
	return context;
}
