...
function getHydrationData({
  ...
  let initialMatches = _chunkVYLTEJXFjs.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunkVYLTEJXFjs.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunkVYLTEJXFjs.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunkVYLTEJXFjs.useRouteError.call(void 0, );
...
function normalizeRedirectLocation(location) {
  location = _chunkVYLTEJXFjs.normalizeRelativeUrl.call(void 0, location);
  if (_chunkVYLTEJXFjs.PROTOCOL_RELATIVE_URL_REGEX.test(location)) {
    let path = _chunkVYLTEJXFjs.resolvePath.call(void 0, location);
...
exports.getHydrationData = getHydrationData; exports.RSCRouterGlobalErrorBoundary = RSCRouterGlobalErrorBoundary; exports.RSCDefaultRootErrorBoundary = RSCDefaultRootErrorBoundary; exports.createRSCRouteModules = createRSCRouteModules; exports.populateRSCRouteModules = populateRSCRouteModules; exports.normalizeRedirectLocation = normalizeRedirectLocation;
