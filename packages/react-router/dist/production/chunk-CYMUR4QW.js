...
function getHydrationData({
  ...
  let initialMatches = _chunk33ARPEUHjs.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunk33ARPEUHjs.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunk33ARPEUHjs.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunk33ARPEUHjs.useRouteError.call(void 0, );
...
function normalizeRedirectLocation(location) {
  if (_chunk33ARPEUHjs.PROTOCOL_RELATIVE_URL_REGEX.test(location)) {
    let path = _chunk33ARPEUHjs.resolvePath.call(void 0, location);
