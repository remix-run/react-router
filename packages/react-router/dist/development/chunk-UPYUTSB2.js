...
function getHydrationData({
  ...
  let initialMatches = _chunk7ALGNJXBjs.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunk7ALGNJXBjs.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunk7ALGNJXBjs.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunk7ALGNJXBjs.useRouteError.call(void 0, );
...
function normalizeRedirectLocation(location) {
  if (_chunk7ALGNJXBjs.PROTOCOL_RELATIVE_URL_REGEX.test(location)) {
    let path = _chunk7ALGNJXBjs.resolvePath.call(void 0, location);
