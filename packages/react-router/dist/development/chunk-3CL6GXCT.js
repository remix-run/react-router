...
function getHydrationData({
  ...
  let initialMatches = _chunkJ67PDNFMjs.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunkJ67PDNFMjs.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunkJ67PDNFMjs.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunkJ67PDNFMjs.useRouteError.call(void 0, );
...
function normalizeRedirectLocation(location) {
  location = _chunkJ67PDNFMjs.normalizeRelativeUrl.call(void 0, location);
  if (_chunkJ67PDNFMjs.PROTOCOL_RELATIVE_URL_REGEX.test(location)) {
    let path = _chunkJ67PDNFMjs.resolvePath.call(void 0, location);
