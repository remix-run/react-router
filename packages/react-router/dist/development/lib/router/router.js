...
function mergeLoaderData(loaderData, newLoaderData, matches, errors) {
	...
	return Object.keys(newLoaderData).length === 0 && loaderDataKeys.length === mergedLoaderDataKeys.length && mergedLoaderDataKeys.every((key) => loaderData.hasOwnProperty(key)) ? loaderData : mergedLoaderData;
}
