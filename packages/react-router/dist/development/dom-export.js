...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunk7ALGNJXBjs.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
      ...
      () => (
        ...
        Promise.resolve(payloadPromise).then(async (payload) => {
          if (payload.type === "redirect") {
            let location2 = _chunkUPYUTSB2js.normalizeRedirectLocation.call(void 0, payload.location);
            if (payload.reload || isExternalLocation(location2)) {
              if (_chunk7ALGNJXBjs.hasInvalidProtocol.call(void 0, location2)) {
          ...
          if (rerender && landedActionId < actionId && globalVar.__routerActionID <= actionId) {
            if (rerender.type === "redirect") {
              let location2 = _chunkUPYUTSB2js.normalizeRedirectLocation.call(void 0, rerender.location);
...
function createRouterFromPayload({
  ...
  _chunkUPYUTSB2js.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunk7ALGNJXBjs.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunk7ALGNJXBjs.createBrowserHistory.call(void 0, ),
    hydrationData: _chunkUPYUTSB2js.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunk7ALGNJXBjs.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunk7ALGNJXBjs.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunk7ALGNJXBjs.getSingleFetchDataStrategyImpl.call(void 0, 
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, trailingSlashAware, targetRoutes) => {
    ...
    let url = _chunk7ALGNJXBjs.singleFetchUrl.call(void 0, request.url, basename, trailingSlashAware, "rsc");
    if (request.method === "GET") {
      url = _chunk7ALGNJXBjs.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunk7ALGNJXBjs.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunk7ALGNJXBjs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunk7ALGNJXBjs.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunk7ALGNJXBjs.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunk7ALGNJXBjs.setIsHydrated.call(void 0, );
  }, []);
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunk7ALGNJXBjs.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunkUPYUTSB2js.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunk7ALGNJXBjs.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunk7ALGNJXBjs.shouldHydrateRouteLoader.call(void 0, 
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunk7ALGNJXBjs.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunk7ALGNJXBjs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
...
async function fetchAndApplyManifestPatches(paths, createFromReadableStream, fetchImplementation, signal) {
  paths = _chunk7ALGNJXBjs.getPathsWithAncestors.call(void 0, paths);
