...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunkJDQ6TNFAjs.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
        ...
        Promise.resolve(payloadPromise).then(async (payload) => {
          if (payload.type === "redirect") {
            ...
            if (payload.reload || isExternalLocation(location2)) {
              if (_chunkJDQ6TNFAjs.hasInvalidProtocol.call(void 0, location2)) {
...
function createRouterFromPayload({
  ...
  _chunkLDPCJFCGjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunkJDQ6TNFAjs.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunkJDQ6TNFAjs.createBrowserHistory.call(void 0, ),
    hydrationData: _chunkLDPCJFCGjs.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunkJDQ6TNFAjs.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunkJDQ6TNFAjs.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunkJDQ6TNFAjs.getSingleFetchDataStrategyImpl.call(void 0, 
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, trailingSlashAware, targetRoutes) => {
    ...
    let url = _chunkJDQ6TNFAjs.singleFetchUrl.call(void 0, request.url, basename, trailingSlashAware, "rsc");
    if (request.method === "GET") {
      url = _chunkJDQ6TNFAjs.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunkJDQ6TNFAjs.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunkJDQ6TNFAjs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunkJDQ6TNFAjs.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunkJDQ6TNFAjs.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunkJDQ6TNFAjs.setIsHydrated.call(void 0, );
  }, []);
  ...
  return /* @__PURE__ */ React3.createElement(_chunkJDQ6TNFAjs.RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3.createElement(_chunkLDPCJFCGjs.RSCRouterGlobalErrorBoundary, { location: state.location }, /* @__PURE__ */ React3.createElement(_chunkJDQ6TNFAjs.FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3.createElement(
    _chunkJDQ6TNFAjs.RouterProvider,
    {
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunkJDQ6TNFAjs.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunkLDPCJFCGjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunkJDQ6TNFAjs.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunkJDQ6TNFAjs.shouldHydrateRouteLoader.call(void 0, 
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunkJDQ6TNFAjs.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunkJDQ6TNFAjs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
...
function normalizeRedirectLocation(location2) {
  if (_chunkJDQ6TNFAjs.PROTOCOL_RELATIVE_URL_REGEX.test(location2)) {
    let path = _chunkJDQ6TNFAjs.resolvePath.call(void 0, location2);
