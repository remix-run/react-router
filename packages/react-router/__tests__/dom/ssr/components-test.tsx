...
describe("<Links>", () => {
  let { Links } = require("../../../lib/dom/ssr/components");

  function createLinksTestContext() {
    return mockFrameworkContext({
      routeModules: {
        root: {
          default: () => null,
  ...
  it("renders stylesheet links with crossOrigin attribute when provided", () => {
    let context = createLinksTestContext();
      ...
      router = createMemoryRouter([
        {
          id: "root",
          path: "/",
          element: <RootWithLinks crossOrigin="anonymous" />,
