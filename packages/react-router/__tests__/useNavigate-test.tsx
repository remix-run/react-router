...
describe("useNavigate", () => {
  ...
  it("throws on invalid destination path objects", () => {
    ...
    expect(() =>
      ...
      `"Cannot include a '?' character in a manually specified \`to.pathname\` field - please separate it out to the \`to.search\` field. Alternatively you may provide the full path as a string and the router will parse it for you"`
    );
    ...
    expect(() =>
      ...
      `"Cannot include a '#' character in a manually specified \`to.pathname\` field - please separate it out to the \`to.hash\` field. Alternatively you may provide the full path as a string and the router will parse it for you"`
    );
    ...
    expect(() =>
      ...
      `"Cannot include a '#' character in a manually specified \`to.search\` field - please separate it out to the \`to.hash\` field. Alternatively you may provide the full path as a string and the router will parse it for you"`
    );
  });
