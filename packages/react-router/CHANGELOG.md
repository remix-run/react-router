...
- Fix route ranking/scoring bug with dynamic parameters containing static extension suffixes (i.e., `/:name.xml`) ([#15273](https://github.com/remix-run/react-router/pull/15273))
