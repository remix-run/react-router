...
- `useRoutes` should be able to return `null` when passing `locationArg` ([#9485](https://github.com/remix-run/react-router/pull/9485)) ([#9506](https://github.com/remix-run/react-router/pull/9506))
