      ...
      r = history.createLocation(
        a
          ? "string" == typeof i
            ...
            : _extends({}, i, { pathname: generatePath(i.pathname, a.params) })
          : i
      );
    return n
      ? (o(r), null)
    ...
    (e.prototype.render = function() {
      ...
      return React.createElement(context.Consumer, null, function(t) {
        ...
        return (
          ...
          "function" == typeof r && void 0 === (r = r(n)) && (r = null),
          React.createElement(
            context.Provider,
            { value: n },
            r && !isEmptyChildren(r)
...
var StaticRouter = (function(r) {
    function t() {
      for (var e, t = arguments.length, n = new Array(t), o = 0; o < t; o++)
        n[o] = arguments[o];
      return (
        ((e = r.call.apply(r, [this].concat(n)) || this).handlePush = function(
          t
        ) {
    ...
    return (
      (e.navigateTo = function(t, e) {
        var n = this.props,
          ...
          a = n.context;
        (a.action = e),
          (a.location = addBasename(r, history.createLocation(t))),
          (a.url = createURL(a.location));
      }),
      (e.render = function() {
        var t = this.props,
          e = t.basename,
...
function withRouter(o) {
  ...
  return (
    (t.displayName = "withRouter(" + (o.displayName || o.name) + ")"),
    (t.WrappedComponent = o),
    hoistStatics(t, o)
  );
}
