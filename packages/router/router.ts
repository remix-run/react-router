...
export interface Router {
   ...
   */
  getBlocker(key: string, fn?: ShouldBlockFunction): Blocker | undefined;
...
export function createRouter(init: RouterInit): Router {
  ...
  function getBlocker(key: string, fn?: ShouldBlockFunction) {
