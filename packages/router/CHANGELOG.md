...
- fix: reset `actionData` after successful action redirect (#9334) ([#9334](https://github.com/remix-run/react-router/pull/9334))
- fix: update matchPath to avoid false positives on dash-separated segments (#9300) ([#9300](https://github.com/remix-run/react-router/pull/9300))
