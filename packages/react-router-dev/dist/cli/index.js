 ...
 * @license MIT
 */
import { g as preloadVite, h as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-XZ33G1kL.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-Bbqal6sX.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-BXU3qBEV.js");
	if (options.profile) await start();
