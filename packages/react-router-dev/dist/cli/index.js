 ...
 * @license MIT
 */
import { _ as preloadVite, g as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-CEKt5q1P.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-CE5rM7Fp.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-CPRUOlgF.js");
	if (options.profile) await start();
