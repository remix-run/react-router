 ...
 * @license MIT
 */
import { _ as preloadVite, g as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-DkxCqPg5.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-CNYqXaSX.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-Vc3P3gwR.js");
	if (options.profile) await start();
