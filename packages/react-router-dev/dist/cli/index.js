 ...
 * @license MIT
 */
import { g as preloadVite, h as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-BZGte5C8.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-7fDZRnvD.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-ClFesArw.js");
	if (options.profile) await start();
