 ...
 * @license MIT
 */
import { _ as getVite, l as hasNodeDependency, n as watch, t as run$1, u as loadConfig, v as preloadVite } from "../typegen-WywajSVn.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-CsJF5XUO.js");
...
async function dev(root, options = {}) {
	if (developmentConditionEnabled) {
		let { dev } = await import("../dev-_GaivbeG.js");
		if (options.profile) await start();
