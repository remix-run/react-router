 ...
 * @license MIT
 */
import { _ as preloadVite, g as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-DFKJaMsU.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-GWdw4O4q.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-B17Ni7K5.js");
	if (options.profile) await start();
