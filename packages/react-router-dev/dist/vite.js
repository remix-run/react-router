 ...
 * @license MIT
 */
import { _ as preloadVite, a as t, c as createConfigLoader, d as resolveRSCEntryFiles, f as ssrExternals, g as getVite, h as getUserBuildRollupOptions, i as parse$1, m as defineOptimizeDepsCompilerOptions, n as watch, o as traverse, p as defineCompilerOptions, r as generate, s as configRouteToBranchRoute, u as resolveEntryFiles } from "./typegen-CEKt5q1P.js";
...
format: config.serverModuleFormat }
		...
		},
		{
			...
			resolveId(id) {
				if (id === virtual.future.id) return virtual.future.resolvedId;
			},
			load(id) {
				if (id === virtual.future.resolvedId) return `export default ${JSON.stringify(config.future)};`;
			}
		},
		{
