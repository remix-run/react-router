...
async function resolveConfig({ root, viteRunnerContext, reactRouterConfigFile, skipRoutes, validateConfig, mode }) {
	...
	let future = {
		...
		unstable_traverseCache: userTraverseCache === true ? mode !== "development" : userTraverseCache === "force" ? true : false
	};
...
async function resolveEntryFiles({ rootDirectory, reactRouterConfig }) {
	...
	if (userEntryServerFile) entryServerFile = userEntryServerFile;
		...
		if (!((await readPackageJSON(packageJsonDirectory)).dependencies ?? {})["isbot"]) {
...
//#endregion
export { preloadVite as _, t$1 as a, createConfigLoader as c, resolveRSCEntryFiles as d, ssrExternals as f, getVite as g, getUserBuildRollupOptions as h, parse$1 as i, loadConfig as l, defineOptimizeDepsCompilerOptions as m, watch as n, traverse as o, defineCompilerOptions as p, generate as r, configRouteToBranchRoute as s, run as t, resolveEntryFiles as u };
