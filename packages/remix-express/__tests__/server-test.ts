...
import { createRequestHandler as createRemixRequestHandler } from "react-router/server";
...
jest.mock("react-router/server", () => {
  let original = jest.requireActual("react-router/server");
  return {
    ...original,
