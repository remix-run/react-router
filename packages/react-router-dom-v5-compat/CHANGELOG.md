...
- Fix SSR `useLayoutEffect` `console.error` when using `CompatRouter` ([#9820](https://github.com/remix-run/react-router/pull/9820)) ([#9975](https://github.com/remix-run/react-router/pull/9975))
