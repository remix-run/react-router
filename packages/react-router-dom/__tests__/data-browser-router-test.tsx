...
function testDomRouter(
  ...
  describe(`Router: ${name}`, () => {
    ...
    describe("useFetcher(s)", () => {
      ...
      it("supports inline loaders in fetcher.load()", async () => {
        let router = createTestRouter(
          [
            {
              path: "/",
      ...
      it("inline loaders override the fetch route loader", async () => {
        let router = createTestRouter(
          [
            {
              path: "/",
      ...
      it("supports inline actions in fetcher.submit()", async () => {
        let router = createTestRouter(
          [
            {
              path: "/",
      ...
      it("inline actions override the fetch route action", async () => {
        let router = createTestRouter(
          [
            {
              path: "/",
