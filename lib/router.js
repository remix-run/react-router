...
/**
 * A convenience method for creating a Router from a <Route> component.
 *
 *   var router = Router.fromComponent(
 *     <Route handler={App}>
...
Router.fromComponent = function (routeComponent) {
  ...
  var router = new Router(routeComponent.props.name, routeComponent.props.path, routeComponent.props.handler);
