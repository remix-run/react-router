...
**NOTE: v2.4.0 and higher include a higher-order component `withRouter` that is now the preferred way of accessing the `router` object.** Read [the v2.4.0 upgrade guide](/upgrade-guides/v2.4.0.md) for more details.
