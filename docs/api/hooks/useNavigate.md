...
[Reference Documentation ↗](https://api.reactrouter.com/v8/functions/react-router.useNavigate.html)
...
* `to` can be a string path, a [`To`](https://api.reactrouter.com/v8/types/react-router.To.html) object, or a number (delta)
* `options` contains options for modifying the navigation
  * These options work in all modes (Framework, Data, and Declarative):
    ...
    * `state`: Optional [`history.state`](https://developer.mozilla.org/en-US/docs/Web/API/History/state) to include with the new [`Location`](https://api.reactrouter.com/v8/interfaces/react-router.Location.html)
...
### Navigate with a [`To`](https://api.reactrouter.com/v8/types/react-router.To.html) object
