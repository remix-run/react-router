...
[Reference Documentation ↗](https://api.reactrouter.com/v8/functions/react-router.useBlocker.html)
...
The [`Blocker`](https://api.reactrouter.com/v8/types/react-router.Blocker.html) object returned by the hook has the following properties:
...
- **`location`**
  - When in a `blocked` state, this represents the [`Location`](https://api.reactrouter.com/v8/interfaces/react-router.Location.html) to which
...
A [`Blocker`](https://api.reactrouter.com/v8/types/react-router.Blocker.html) object with state and reset functionality
