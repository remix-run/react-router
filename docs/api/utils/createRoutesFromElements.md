...
An array of [`RouteObject`](https://api.reactrouter.com/v8/types/react-router.RouteObject.html)s that can be used with a [`DataRouter`](https://api.reactrouter.com/v8/interfaces/react-router.DataRouter.html)
