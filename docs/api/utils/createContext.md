...
[Reference Documentation ↗](https://api.reactrouter.com/v8/functions/react-router.createContext.html)

Creates a type-safe [`RouterContext`](https://api.reactrouter.com/v8/interfaces/react-router.RouterContext.html) object that can be used to
...
A [`RouterContext`](https://api.reactrouter.com/v8/interfaces/react-router.RouterContext.html) object that can be used with
