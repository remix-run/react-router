...
1. No need to manually import hooks like useParams, useLoaderData, or useLocation.
2. Route data is directly accessible via props, leading to more readable code.
