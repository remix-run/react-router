...
First install `react-router-dom` and `history` with [npm](https://www.npmjs.com/) ([Yarn](https://yarnpkg.com/) works too).
...
Follow the instructions in the [Parcel documentation to set up a new project](https://parceljs.org/getting_started.html) then install React and React Router dependencies with [npm](https://www.npmjs.com/) ([Yarn](https://yarnpkg.com/) works too).

```sh
$ npm install parcel-bundler react react-dom @babel/preset-react history@5 react-router-dom@6
```
