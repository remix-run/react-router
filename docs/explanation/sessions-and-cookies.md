...
[is-session]: https://api.reactrouter.com/v7/variables/react-router.isSession.html
[cookie-api]: https://api.reactrouter.com/v7/interfaces/react-router.Cookie
[create-session-storage]: https://api.reactrouter.com/v7/functions/react-router.createSessionStorage.html
[create-session]: https://api.reactrouter.com/v7/variables/react-router.createSession.html
[create-memory-session-storage]: https://api.reactrouter.com/v7/functions/react-router.createMemorySessionStorage.html
...
[is-cookie]: https://api.reactrouter.com/v7/variables/react-router.isCookie.html
[create-cookie]: https://api.reactrouter.com/v7/functions/react-router.createCookie.html
