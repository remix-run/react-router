...
👉 **Install v7 pre-release**

```shellscript nonumber
npm install react-router-dom@pre
```

Your app should continue to work but you will get console warnings about your imports from "react-router-dom", let's tackle that next.
