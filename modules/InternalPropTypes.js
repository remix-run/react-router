import { func, object, arrayOf, oneOfType, element, shape, string, number, symbol } from 'prop-types'
...
export const component = oneOfType([ func, string, object, number, symbol ])
