...
describe('Router', function () {
  ...
  describe('at a route with special characters', function () {
    it('does not double escape', function (done) {
      // https://github.com/reactjs/@americanexpress/one-app-router/issues/1574
    ...
    it('is happy to have colons in parameter values', function (done) {
      // https://github.com/reactjs/@americanexpress/one-app-router/issues/1759
      class MyComponent extends Component {
        render() {
    ...
    it('handles % in parameters', function (done) {
      // https://github.com/reactjs/@americanexpress/one-app-router/issues/1766
      class MyComponent extends Component {
        render() {
    ...
    it('handles forward slashes', function (done) {
      // https://github.com/reactjs/@americanexpress/one-app-router/issues/1865
      class Parent extends Component {
        render() {
