...
const TEST_ROUTES = [
  ...
  "bundle_a.tsx",
  "bundle_a._index.tsx",
  "bundle_a.route-a.tsx",
  "bundle_a.route-b.tsx",

  // Bundle B doesn't have an index route
  "bundle_b.tsx",
  "bundle_b.route-a.tsx",
  "bundle_b.route-b.tsx",

  // Bundle C is nested in a pathless route
  "_pathless.tsx",
  "_pathless.bundle_c.tsx",
  "_pathless.bundle_c.route-a.tsx",
  "_pathless.bundle_c.route-b.tsx",
];
      ...
      test.describe("build", () => {
        ...
        test("server", async ({ page }) => {
          ...
          await withBundleServer(cwd, "bundle_a", async (port) => {
            ...
            await page.goto(`http://localhost:${port}/bundle_a/route-a`);
            await expectRenderedRoutes(page, [
              "bundle_a.tsx",
              "bundle_a.route-a.tsx",
            ]);

            await page.goto(`http://localhost:${port}/bundle_a/route-b`);
            await expectRenderedRoutes(page, [
              "bundle_a.tsx",
              "bundle_a.route-b.tsx",
            ]);
          ...
          await withBundleServer(cwd, "bundle_b", async (port) => {
            ...
            await page.goto(`http://localhost:${port}/bundle_b/route-a`);
            await expectRenderedRoutes(page, [
              "bundle_b.tsx",
              "bundle_b.route-a.tsx",
            ]);

            await page.goto(`http://localhost:${port}/bundle_b/route-b`);
            await expectRenderedRoutes(page, [
              "bundle_b.tsx",
              "bundle_b.route-b.tsx",
            ]);
          ...
          await withBundleServer(cwd, "bundle_c", async (port) => {
            ...
            await page.goto(`http://localhost:${port}/bundle_c/route-a`);
            await expectRenderedRoutes(page, [
              "_pathless.tsx",
              "_pathless.bundle_c.tsx",
              "_pathless.bundle_c.route-a.tsx",
            ...
            await page.goto(`http://localhost:${port}/bundle_c/route-b`);
            await expectRenderedRoutes(page, [
              "_pathless.tsx",
              "_pathless.bundle_c.tsx",
              "_pathless.bundle_c.route-b.tsx",
        ...
        test("React Router build manifest", () => {
          ...
          expect(JSON.parse(fs.readFileSync(manifestPath, "utf8"))).toEqual({
            ...
            routeIdToServerBundleId: {
              "routes/_pathless.bundle_c.route-a": "bundle_c",
              "routes/_pathless.bundle_c.route-b": "bundle_c",
              "routes/_pathless.bundle_c": "bundle_c",
              "routes/bundle_a.route-a": "bundle_a",
              "routes/bundle_a.route-b": "bundle_a",
              "routes/bundle_b.route-a": "bundle_b",
              "routes/bundle_b.route-b": "bundle_b",
            ...
            routes: {
              ...
              "routes/_pathless.bundle_c.route-a": {
                file: "app/routes/_pathless.bundle_c.route-a.tsx",
                id: "routes/_pathless.bundle_c.route-a",
                path: "route-a",
                parentId: "routes/_pathless.bundle_c",
              },
              "routes/_pathless.bundle_c.route-b": {
                file: "app/routes/_pathless.bundle_c.route-b.tsx",
                id: "routes/_pathless.bundle_c.route-b",
                path: "route-b",
                parentId: "routes/_pathless.bundle_c",
              },
              ...
              "routes/bundle_a.route-a": {
                file: "app/routes/bundle_a.route-a.tsx",
                id: "routes/bundle_a.route-a",
                path: "route-a",
                parentId: "routes/bundle_a",
              },
              "routes/bundle_a.route-b": {
                file: "app/routes/bundle_a.route-b.tsx",
                id: "routes/bundle_a.route-b",
                path: "route-b",
                parentId: "routes/bundle_a",
              },
              "routes/bundle_b.route-a": {
                file: "app/routes/bundle_b.route-a.tsx",
                id: "routes/bundle_b.route-a",
                path: "route-a",
                parentId: "routes/bundle_b",
              },
              "routes/bundle_b.route-b": {
                file: "app/routes/bundle_b.route-b.tsx",
                id: "routes/bundle_b.route-b",
                path: "route-b",
                parentId: "routes/bundle_b",
              },
